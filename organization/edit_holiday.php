...
<head>
    ...
    <title> Ericsson :: Edit Holiday</title>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="Holiday-add-Boot">
                            <div class="card">
                                ...
                                <form class="card-body" action="../backend/holiday_crud.php?edit_id=<?php echo $edit_id; ?>" method="post">
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Title</label>
                                        <div class="col-md-7">
                                            <input type="text" class="form-control" name="title" value="<?php echo $holiday['title']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-7">
                                            <select class="form-control input-height" name="holiday_type">
                                                ...
                                                <option <?php if ($holiday['holiday_type'] == 'Public Holiday') {
                                                            echo 'selected';
                                                        } ?>>Public Holiday</option>
                                                <option <?php if ($holiday['holiday_type'] == 'Holiday By Organization') {
                                                            echo 'selected';
                                                        } ?>>Holiday By Organization</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Holiday Start Date </label>
                                        <div class="col-md-7">
                                            <input data-provide="datepicker" data-date-autoclose="true" class="form-control" placeholder="" name="start_date" value="<?php echo date('m-d-Y', strtotime($holiday['start_date'])); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Holiday End Date </label>
                                        <div class="col-md-7">
                                            <input data-provide="datepicker" data-date-autoclose="true" class="form-control" placeholder="" name="end_date" value="<?php echo date('m-d-Y', strtotime($holiday['end_date'])); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label"></label>
                                        <div class="col-md-7">
                                            <button type="submit" class="btn btn-primary" name="edit_holiday">Update</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
